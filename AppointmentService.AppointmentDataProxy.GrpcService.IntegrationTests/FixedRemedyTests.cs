...
public class FixedRemedyTests(GrpcServiceTestFixture<Program> serviceTestFixture, ITestOutputHelper outputHelper) : IntegrationTestBase(serviceTestFixture, outputHelper)
    {
        [Fact]
