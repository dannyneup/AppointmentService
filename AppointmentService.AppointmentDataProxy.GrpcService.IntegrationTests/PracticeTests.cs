...
{
    protected override string[] TokenScopes => [Constants.Authorization.Scopes.General];
    ...
    public async Task Stream_WhenFilteredByInstitutionCode_ShouldReturnFilteredPractices(StringFilter filter,
        string id,
        bool expected)
    {
        var client = new PracticeService.PracticeServiceClient(Channel);
    ...
    [Theory]
    [MemberData(nameof(SharedFilterCases.StringCases), MemberType = typeof(SharedFilterCases))]
    public async Task Stream_WhenFilteredByName_ShouldReturnFilteredPractices(StringFilter filter,
        string name,
        bool expected)
    {
        var client = new PracticeService.PracticeServiceClient(Channel);
    ...
    private static async Task<IReadOnlyCollection<Practice>> ReadPracticeStreamAsync(
        PracticeService.PracticeServiceClient client,
        PracticeFilter? filter = null)
    {
